...
| Chat | Persistent local history, unchanged attachment references, desktop rename/delete/export, streaming and cancellation; web chat has session selection, rename/delete, stream/stop, Markdown export, response copy and retry after errors | Regenerate, per-chat settings/presets, attachments, audio attachments |
